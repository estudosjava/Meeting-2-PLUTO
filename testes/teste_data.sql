...
begin
  ...
  v_util_obj.is_ok( data_got => Valida_Data(p_matricula,p_data_admissao), data_expected => true, test_label => 'Data de Admissão Inválida');
  v_util_obj.is_ok( data_got => Valida_Data(p_matricula,p_data_admissao_erro), data_expected => false, test_label => 'Data de Admissão Inválida');
